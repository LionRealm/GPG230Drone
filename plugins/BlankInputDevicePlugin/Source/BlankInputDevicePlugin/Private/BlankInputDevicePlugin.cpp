...
EKeys::AddKey(FKeyDetails(FCustomControllerInputs::ControllerButton1, FText::FromString(TEXT("Custom Controller Button 1")), FKeyDetails::GamepadKey, FName("Custom Controller")));
EKeys::AddKey(FKeyDetails(FCustomControllerInputs::ControllerButton2, FText::FromString(TEXT("Custom Controller Button 2")), FKeyDetails::GamepadKey, FName("Custom Controller")));
EKeys::AddKey(FKeyDetails(FCustomControllerInputs::ControllerButton3, FText::FromString(TEXT("Custom Controller Button 3")), FKeyDetails::GamepadKey, FName("Custom Controller")));
EKeys::AddKey(FKeyDetails(FCustomControllerInputs::ControllerButton4, FText::FromString(TEXT("Custom Controller Button 4")), FKeyDetails::GamepadKey, FName("Custom Controller")));
EKeys::AddKey(FKeyDetails(FCustomControllerInputs::ControllerButton5, FText::FromString(TEXT("Custom Controller Button 5")), FKeyDetails::GamepadKey, FName("Custom Controller")));
